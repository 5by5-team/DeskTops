            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h2 class="text-uppercase text-white font-weight-bold">Whatever your business, whatever your budget we’ll help find the right workspace.</h2>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        ...
                        <img class="xxx" src="https://image.flaticon.com/icons/svg/546/546423.svg" alt="" />
                            ...
                            <p class="text-muted mb-0">Pay one simple price for everything related to your workspace.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                        <img class="xxx" src="https://image.flaticon.com/icons/svg/2271/2271406.svg" alt="" />
                            <i class="fas fa-4x fa-laptop-code text-primary mb-4"></i><br/>
                            <h3 class="h4 mb-2">Furnished offices</h3>
                            <p class="text-muted mb-0">Modern furniture and high-speed internet included.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                        <img class="xxx" src="https://image.flaticon.com/icons/svg/2278/2278994.svg" alt="" />
                            <i class="fas fa-4x fa-globe text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Temporary offices</h3>
                            <p class="text-muted mb-0">Set up as a project office and cancel your plan at a month’s notice.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                        <img class="xxx" src="https://image.flaticon.com/icons/svg/813/813802.svg" alt="" />
                            <i class="fas fa-4x fa-heart text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Increase the size</h3>
                            <p class="text-muted mb-0">Add more desk space as you take on new staff.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="portfolio">
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="/login">
                            <img class="img-fluid" src="https://images.pexels.com/photos/840996/pexels-photo-840996.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="" />
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center" href="/contactPage">
                        ...
                        <h5 class="text-muted mb-5">Pay one price for a fully-furnished office, including furniture, WiFi, phones, 
                        utility bills and a staffed reception.!</h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-phone fa-3x mb-3 text-muted"></i>
                        <div class="d-block" style ={{color :'#00848C'}}>phone : +972 59-289-641-0</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        {/* <!-- Make sure to change the email address in BOTH the anchor text and the link target below!--> */}
                        <a class="d-block" href="bookingfinder5by5team@gmail.com">Email : bookingfinder5by5team@gmail.com</a>
                    </div>
                </div>
            </div>
        </section>
